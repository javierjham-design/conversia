...
const GROUPS: { title: string; pages: PageDef[] }[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { href: "/settings/assisted-setup", label: "Montaje asistido de TuBot", keywords: "montaje asistido codigo autorizar implementacion bot configurar cuenta canal", perm: "settings:write", ready: true },
