      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        <article
          className="max-w-none text-sm leading-relaxed text-ink
            [&_h1]:mb-1 [&_h1]:text-2xl [&_h1]:font-semibold [&_h1]:text-ink
            [&_h2]:mb-2 [&_h2]:mt-8 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-ink
            [&_p]:my-3 [&_ul]:my-3 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:my-1
            [&_a]:text-brand-600 [&_a]:underline [&_strong]:text-ink"
        >
          {children}
        </article>
      </main>
      <footer className="mx-auto max-w-3xl px-6 pb-12 text-xs text-ink-subtle">
