...
/**
 * Panel de configuración de COBROS con Flow (credenciales de la cuenta Flow del tenant +
 * ambiente + aviso al equipo + instrucciones). Es config a nivel de CUENTA (no por agente):
 * las llaves se guardan cifradas vía /charging. Se reutiliza en Configuración → Cobros y en
 * la Configuración avanzada del agente (para tenerlo a mano al activar "Cobrar con link").
 */
