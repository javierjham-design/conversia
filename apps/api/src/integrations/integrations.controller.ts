    ...
    return this.prisma.withTenant(ctx.organizationId, async (tx) => {
      ...
      return {
        ...
        catalog: [
          ...
          { key: "instagram", name: "Instagram Direct", category: "meta", status: "beta", description: "DMs de Instagram en la bandeja, atendidos por los mismos agentes IA. Se activa conectando la página en Meta CRM (la cuenta IG debe estar vinculada a la página).", capabilities: ["Mensajes", "Agentes IA", "Flujos por canal"] },
          { key: "messenger", name: "Facebook Messenger", category: "meta", status: "beta", description: "Mensajes de tu página de Facebook en la bandeja, con agentes IA y flujos. Se activa conectando la página en Meta CRM.", capabilities: ["Mensajes", "Agentes IA", "Flujos por canal"] },
